...
async function generateDailyMessage(guildName, dayName, dateStr) {
  try {
    ...
    const text = `Buatkan pesan pagi untuk server Discord "${guildName}" di hari ${dayName}, ${dateStr}. Ingat panduan: sesuaikan dengan nama server ("${guildName}"), tambahkan obrolan cuaca hujan, dan wajib sertakan kutipan filosofi tokoh terkenal.`;
